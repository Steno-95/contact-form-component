  ...
  return (
    <article className="toast" aria-live="assertive">
      <div className="flex items-center gap-2">
        ...
        <h2 aria-label="Message Sent">Message Sent!</h2>
      </div>
      <p
        className="text-[.8rem] text-(--primary-light) w-fit"
        aria-label="Thanks for completing the form. We'll be in touch soon!"
      >
